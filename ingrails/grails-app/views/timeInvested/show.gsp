...
<html>
    ...
    <body>
        ...
        <div id="show-timeInvested" class="content scaffold-show" role="main">
            ...
            <f:display bean="timeInvested" />
            <g:form resource="${this.timeInvested}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.timeInvested}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
